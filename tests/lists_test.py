...
class ListsTest(ExpressPigeonTest):
    ...
    def test_remove_disabled_list(self):
        res = self.api.lists.delete(37308)
        self.assertEqual(res.code, 400)
        self.assertEqual(res.status, "error")
        self.assertEqual(res.message, "could not delete list=37308, list is disabled")
    ...
    def test_export_csv(self):
        ...
        headers = '"Email", "First name", "Last name", "City", "Phone", "Company", "Title", "Address 1", "Address 2", "State", "Zip", "Country", "Date of birth", "custom_field_1", "custom_field_2", "custom_field_3", "custom_field_4", "custom_field_5", "custom_field_6", "custom_field_7", "custom_field_9", "custom_field_10", "custom_field_11", "custom_field_12", "custom_field_13", "custom_field_14", "custom_field_15", "custom_field_16", "custom_field_17", "custom_field_18", "custom_field_19", "custom_field_20", "custom_field_21"'
